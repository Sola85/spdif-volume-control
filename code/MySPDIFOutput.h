 ...
 * @brief S/PDIF output
    ...
    This is a copy of SPDIFOutput.h from the arduino-audio-tools library by Phil Schatzmann.
    This copy was necessary because at the time of developing
    https://github.com/pschatzmann/arduino-audio-tools/issues/1916
    was not yet fixed (now I believe it is fixed).
    Fixing this is the only significant modification to this file.
    - Sola85
...
#ifndef STM32
    i2s_cfg.pin_ws = cfg.pin_data-2;
      i2s_cfg.pin_bck = cfg.pin_data-1;
